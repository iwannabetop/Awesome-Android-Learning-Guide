...
![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/master/images/annotation_1.jpg)

![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/master/images/annotation_2.jpg)
...
从这里可以看到定义一个注解与定义一个接口非常类似，而实际上每个注解都是继承自 Annotation 接口的接口，反编译 CustomizeAnnotation 生成的 class 文件可以看到
...
Activity 中定义一个 CustomizeOnClickListener 内部类
...
![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/master/images/annotation_3.jpg)
...
![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/master/images/annotation_4)
...
* Elements 是一个获取程序元素信息的接口，例如获取元素的包名、判断是否是重写方法，例如![](/assets/2017-10-22 11:51:01屏幕截图.png)

* Filer 则是一个支持通过注解处理器创建文件的接口，可以用于创建 Class文件、源文件、资源文件

![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/master/images/annotation_5.jpg)

* Messager 则是为注解处理器提供的输出错误信息的接口。

![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/master/images/annotation_6.jpg)
...
![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/master/images/annotation_7.jpg)
