...
![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/annotation/images/override_error_pic.png)

![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/annotation/images/overrided_error.png)
...
![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/annotation/images/deprecated_warning.png)
...
![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/annotation/images/suppress_warning.png)
...
![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/annotation/images/safe_varargs_error_pic.png)

![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/annotation/images/safe_varargs_error.png)
...
![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/annotation/images/functional_error_pic.png)

![](https://github.com/iwannabetop/Awesome-Android-Learning-Guide/blob/annotation/images/function_error.png)
...
这里定义了两个注解用于绑定 View 的 id 以及 点击事件，并且指定了注解可以修饰的元素以及保留时间，可以看到定义一个注解与定义一个接口非常类似，而实际上每个注解都是继承自 Annotation 接口的接口，反编译 BindView 生成的 class 文件可以看到
...
所以实际上编译时注解的整个处理过程是利用注解处理器对程序中使用了注解的元素进行遍历，从元素中提取所需的信息，然后生成类文件，最后在程序中加载生成的类并调用其中的方法。
